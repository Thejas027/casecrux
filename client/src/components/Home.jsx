      ...
      <div className="min-h-screen px-8 py-16">
        ...
        <div className="text-center mb-16">
          <div className="flex justify-center items-center mb-8">
            <div className="bg-gradient-to-r from-[#7f5af0] to-[#2cb67d] p-4 rounded-2xl">
              <svg
                className="w-12 h-12 text-[#18181b]"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
          ...
          <p className="text-center text-xl text-[#e0e7ef]/80 mb-4 max-w-3xl mx-auto">
            Your intelligent companion for legal PDF analysis and case
            summarization
          </p>
          <p className="text-center text-sm text-[#a786df]/60 max-w-2xl mx-auto">
            Powered by advanced AI to transform complex legal documents into
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mb-16 max-w-7xl mx-auto">
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-[#e0e7ef]/70 text-sm leading-relaxed">
                Upload and get instant AI-powered summaries of individual legal
                documents with key insights and analysis
              </p>
            </div>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-[#e0e7ef]/70 text-sm leading-relaxed mb-2">
                ...
                Detailed, Concise, Executive analysis
              </p>
              <p className="text-[#e0e7ef]/70 text-sm leading-relaxed">
                <strong className="text-[#4ecdc4]">
                  Abstractive & Extractive:
                </strong>{" "}
                AI-generated insights plus key sentence extraction
              </p>
            </div>
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-[#e0e7ef]/70 text-sm leading-relaxed">
                Search and process multiple legal documents by category with
                comprehensive analysis, pros/cons evaluation, and final
                judgments
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12 max-w-5xl mx-auto">
          <div className="text-center p-6 rounded-xl bg-[#7f5af0]/5 border border-[#7f5af0]/20">
            ...
            <h4 className="text-lg font-semibold text-[#7f5af0] mb-2">
              AI-Powered
            </h4>
          ...
          <div className="text-center p-6 rounded-xl bg-[#ff6b6b]/5 border border-[#ff6b6b]/20">
            ...
            <h4 className="text-lg font-semibold text-[#ff6b6b] mb-2">
              Multi-Level
            </h4>
          ...
          <div className="text-center p-6 rounded-xl bg-[#4ecdc4]/5 border border-[#4ecdc4]/20">
            ...
            <p className="text-sm text-[#e0e7ef]/60">
              Abstractive + Extractive
            </p>
          </div>
          <div className="text-center p-6 rounded-xl bg-[#2cb67d]/5 border border-[#2cb67d]/20">
            ...
            <h4 className="text-lg font-semibold text-[#2cb67d] mb-2">
              Search & Batch
            </h4>
      ...
      <div className="fixed bottom-4 right-4 z-50">
        {isChatbotOpen ? (
          <>
            ...
            >
              <IoClose className="w-6 h-6 text-gray-800 dark:text-gray-200" />
            </button>
            <div
              onClick={(e) => e.stopPropagation()}
              className="mt-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg"
            >
              <Chatbot />
            </div>
          </>
